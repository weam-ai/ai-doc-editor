    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex md:flex-row flex-col">
      ...
      <div className="md:w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 p-4">
        <div className="space-y-6">
          ...
          >
              <circle cx="25" cy="25" r="25" fill="#6637EC" />
              <path
            ...
            <span className="font-semibold text-black">Weam AI</span>
          </div>
                  ...
                  .map((template) => (
                    ...
                    >
                      <CardContent className="p-4">
                        ...
                        <h3 className="font-semibold text-gray-700 dark:text-white text-center group-hover:text-black transition-colors">
                          {template.name}
                        </h3>
                      </CardContent>
                    </Card>
