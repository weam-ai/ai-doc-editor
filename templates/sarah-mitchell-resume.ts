    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:12px;box-shadow:0 8px 24px rgba(0,0,0,.06);padding:32px;">
      ...
      <div style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:20px;margin:16px 0 10px;">
        <div>
          ...
          <p style="margin:0 0 0 0;font-size:13px;color:#444;">(650) 342-7896</p>
        </div>
        <div>
          ...
          <p style="margin:0 0 0 0;font-size:13px;color:#444;">San Francisco, CA</p>
        </div>
        <div>
      ...
      <div style="display:grid;grid-template-columns:60% 40%;gap:28px;align-items:start;">
        ...
        <div>
          ...
          <div style="margin:18px 0;">
            ...
            <p style="margin:8px 0 0 0;font-size:13px;color:#555;text-align:justify;">
          ...
          <h2 style="margin:20px 0 10px 0;font-size:24px;font-weight:700;color:#6b9bd6;">Awards</h2>
        ...
        <div>
          <!-- Optional photo -->
          <img src="https://via.placeholder.com/720x400.png?text=Professional+Photo"
               alt="Professional headshot"
               style="width:100%;height:180px;object-fit:cover;border-radius:6px;border:2px solid #e5e7eb;margin:0 0 14px 0;" />

          <div style="font-size:12px;color:#6b9bd6;margin:0 0 16px 0;">
          ...
          <h2 style="margin:0 0 10px 0;font-size:22px;font-weight:700;color:#6b9bd6;">About</h2>
          <p style="margin:0 0 16px 0;font-size:13px;color:#555;text-align:justify;line-height:1.6;">
          ...
          <h2 style="margin:0 0 10px 0;font-size:22px;font-weight:700;color:#6b9bd6;">Education</h2>
          <div style="margin:0 0 12px 0;">
            <span style="display:block;margin:0 0 4px 0;font-size:16px;font-weight:700;color:#333;">
              BFA, Visual Communication
            </span>
            <span style="font-size:14px;color:#666;font-style:italic;">2010 – 2013</span>
            <p style="margin:6px 0 0 0;font-size:12px;color:#555;text-align:justify;">
